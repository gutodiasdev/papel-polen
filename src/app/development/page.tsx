...
export default function Home() {
  return (
    <main className="min-h-screen min-w-full">
      ...
      md:bg-[right_-8rem_top] md:bg-contain ">
        <div className="flex flex-col md:flex-row gap-x-8 gap-y-6 items-center py-8 px-3 md:px-6">
        ...
        <div className="px-3 py-8 md:w-1/2 md:px-6">
      ...
      <section className="px-3 md:px-6 py-8 md:grid md:grid-cols-2 md:gap-x-4 md:overflow-hidden md:items-center">
      ...
      <section className="px-3 md:px-6 py-8 bg-[url('/why_use_background.svg')] bg-no-repeat bg-[right_-24rem_top_-6rem]
      md:bg-[left_top] bg-contain md:grid md:grid-cols-2">
        <div></div>
        <div>
          <h2 className="text-5xl">
      ...
      <section className="bg-[url('/background.svg')] grid grid-cols-1 px-3 md:px-6 py-8 md:py-16
      md:grid md:grid-cols-2 md:overflow-hidden md:items-center">
        <div>
          <h2 className="text-5xl">
            Mais próximo da natureza
          </h2>
        </div>
        <div className="grid grid-cols-1 gap-y-4 py-8 md:flex">
          <div className="bg-[url('/dark_tag.svg')] bg-no-repeat bg-contain text-[#FFF7E0] p-8 min-h-[400px] md:min-w-[300px]">
      ...
      md:bg-[right_top] md:bg-contain md:grid md:grid-cols-2">
      ...
      md:bg-[right_top] md:grid md:grid-cols-2">
        <div>
